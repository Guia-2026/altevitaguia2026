  ...
  const content = {
    ...
    medicacao: `
      ...
      <div class="content-card content-card-destructive">
        ...
        <div class="table-wrap"><table class="content-table"><thead><tr><th>Medicamento</th><th>Evitar com</th><th>Risco</th></tr></thead><tbody><tr><td style="font-weight:500">Anticoagulantes (Varfarina)</td><td>AINEs, Vitamina K (folhas verdes)</td><td class="text-destructive">Sangramento</td></tr><tr><td style="font-weight:500">Anti-hipertensivos</td><td>AINEs, Descongestionantes</td><td class="text-destructive">Pressão descontrolada</td></tr><tr><td style="font-weight:500">Levodopa</td><td>Proteínas, Ferro, Vitamina B6</td><td class="text-destructive">Reduz absorção</td></tr><tr><td style="font-weight:500">Donepezila (Alzheimer)</td><td>Anticolinérgicos</td><td class="text-destructive">Anula efeito</td></tr><tr><td style="font-weight:500">Sedativos/Ansiolíticos</td><td>Álcool, outros sedativos</td><td class="text-destructive">Depressão respiratória</td></tr></tbody></table></div>
    ...
    emergencias: `
      ...
      <div class="content-card content-card-destructive">
        ...
        <ul class="content-list"><li>Camufle portas de saída (pinte da cor da parede)</li><li>Coloque espelhos nas portas (confunde a percepção)</li><li>Sensores de abertura com alerta sonoro no celular</li><li>Fechaduras altas ou escondidas (fora do campo visual)</li></ul>
